...
function log(line) {
    fs_1.default.appendFileSync('./log.txt', `${line}\n`);
}
describe('server functions', () => {
    ...
    beforeAll(async () => {
        ...
        log(JSON.stringify(server === null || server === void 0 ? void 0 : server.address()));
    });
    ...
    test('listen for statuses', () => new Promise(async (resolve, reject) => {
        const payloads = [
            {
                id: 'wamid.abcdef',
                status: 'failed',
        ...
        bot.on('status', async (payload) => {
            ...
            expect(Object.values(pubSub_1.PubSubEvents)).toContain(status.status);
            if (status.errors) {
            ...
            switch (status.status) {
                ...
                case 'failed':
                    ...
                    expect((_a = status.errors) === null || _a === void 0 ? void 0 : _a[0]).toHaveProperty('code');
                    expect((_b = status.errors) === null || _b === void 0 ? void 0 : _b[0]).toHaveProperty('title');
                    expect(typeof ((_c = status.errors) === null || _c === void 0 ? void 0 : _c[0].code)).toBe('number');
                    expect(typeof ((_d = status.errors) === null || _d === void 0 ? void 0 : _d[0].title)).toBe('string');
                    break;
                default:
                    break;
            }
